...
class SeoRepairKit_Upgrade {
    ...
    public function seo_repair_kit_upgrade_pro() {
        ...
        <div class="wrap srk-upgrade-wrap">
            ...
            <p class="srk-subtitle"><?php esc_html_e( 'Choose the SEO tools you need for this WordPress site.', 'seo-repair-kit' ); ?></p>
                        ...
                        <div class="srk-benefits" role="list">
                            ...
                            <div class="srk-benefit srk-benefit-support" role="listitem">
                                ...
                                <div class="srk-benefit-content">
                                    ...
                                    <p>
                                        <?php esc_html_e('Need help choosing the right module or comparing freelancer and agency packages?', 'seo-repair-kit'); ?>
