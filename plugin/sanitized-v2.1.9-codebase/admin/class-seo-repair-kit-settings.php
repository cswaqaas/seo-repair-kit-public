                                ...
                                <?php foreach ( $srkit_publicposttypes as $srkit_settingsposttype ) : ?>
                                    ...
                                    <label class="srk-checkbox-item <?php echo $is_allowed ? '' : 'srk-checkbox-item-disabled'; ?>">
                                        ...
                                        <span class="srk-checkbox-label">
                                            ...
                                            <?php if ( ! $is_allowed ) : ?>
                                                <span class="srk-checkbox-plan-note"><?php esc_html_e( 'Broken Links + 404 Monitor add-on', 'seo-repair-kit' ); ?></span>
                                            <?php endif; ?>
                                        </span>
                                    </label>
                                <?php endforeach; ?>
                                ...
                                <div class="srk-info-box srk-scanner-settings-note">
                                    ...
                                    <div class="srk-info-content">
                                        ...
                                        <p>
                                            <?php
                                            printf(
                                                esc_html__( 'Pages are available for free up to %d links per scan. Posts and public custom post types require the $1.99 Broken Links + 404 Monitor add-on.', 'seo-repair-kit' ),
