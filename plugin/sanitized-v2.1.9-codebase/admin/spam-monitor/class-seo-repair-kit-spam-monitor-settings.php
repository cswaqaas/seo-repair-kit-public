	...
	public function render() {
		...
		<div class="srk-stg-wrap">
			...
			<div class="srk-stg-header">
				...
				<p><?php esc_html_e( 'Production settings are intentionally simple. SRK Cloud connection details are managed in code, while scan rules, provider connection, and alerts are managed from their dedicated tabs.', 'seo-repair-kit' ); ?></p>
			</div>
