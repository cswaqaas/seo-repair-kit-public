...
class SeoRepairKit_ScanLinks {
    ...
    public function seorepairkit_scanning_link() {
        ...
        if ( $srkit_limit_reached ) {
            echo '<div class="srk-scanner-limit-message"><span class="dashicons dashicons-lock"></span><p>' . esc_html( sprintf( __( 'Free Link Scanner stopped at %d links. Add Broken Links + 404 Monitor for $1.99/month to scan all links, Posts, and public custom post types.', 'seo-repair-kit' ), absint( $scanner_free_limit ) ) ) . '</p></div>';
        }
